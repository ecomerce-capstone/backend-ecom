// //ini helper untuk seragamkan response dari server
...
// /** Common HTTP status codes used in the app. Extend if needed. */
...
// /** Enum for convenience ( can be use for mapping ) */
...
// //response error
// //* - code: limited to HttpStatus union; defaults to 500 jadi default server error
// //* - message: default "server error"
// //* - errors: optional array of field-specific errors

// export function error(
//   //ini default param di js/ts
//   res: Response,
//   code: HttpStatus = 500,
...
// //response loading
// /**
//  * loading response — usually for async jobs returning 202
//  * Example: return loading(res, { jobId: 'abc' }, 'Job started')
//  */
...
// //utk type safety param agar tahu  apa benar param ada isinya /type guard
// function hasParam(e: unknown): e is { param: string } {
//   return (
//     typeof e === "object" &&
//     e !== null &&
//     "param" in e &&
...
// export function mapValidationErrors(errs: ValidationError[]): ResponseError[] {
//   return errs.map((e) => {
//     const field = hasParam(e) ? e.param : undefined;
